...
import BlurImg from "@/components/img";
...
export async function generateMetadata({
  ...
  return {
    ...
    // ...(params.domain.endsWith(`.${Niche.domain}`) &&
...
//     .flatMap(({ site, slug }) => [
//       site?.subdomain && {
//         domain: `${site.subdomain}.${Niche.domain}`,
//         slug,
//       },
//       site?.customDomain && {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center">
        <div className="m-auto w-full text-center sm:w-10/12 xl:w-8/12 2xl:w-2/5">
      ...
      {data.image && <div className="relative m-auto mb-10 h-80 w-full max-w-screen-lg overflow-hidden md:mb-20 md:h-150 md:w-5/6 md:rounded-2xl lg:w-2/3">
        <BlurImg
